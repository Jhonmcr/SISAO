...
// Soporta paginación a través de query parameters `page` y `limit`.
// Excluye los campos `actuaciones` y `modificaciones` para optimizar la respuesta inicial.
...
// Utiliza el middleware `upload.single('archivo')` de Multer para manejar la subida del archivo PDF.
// El archivo se espera en un campo llamado 'archivo' en el FormData.
router.post('/', upload.single('archivo'), async (req, res) => {
    ...
    try {
        ...
        console.error('Error detallado al crear el caso en el router:', error);
...
// Esta ruta puede ser usada, por ejemplo, cuando se modifica un caso y se quiere cambiar el archivo PDF asociado.
...
router.get('/:id', async (req, res) => {
    try {
        ...
        console.error('Error al obtener el caso por ID en el router:', error);
...
// Se usa PATCH porque generalmente se actualizan solo algunos campos del caso.
router.patch('/:id', async (req, res) => {
    try {
        ...
        console.error('Error al actualizar el caso en el router:', error);
...
router.patch('/:id/estado', async (req, res) => {
    try {
        ...
        console.error('Error al actualizar el estado del caso en el router:', error);
...
// Requiere una clave de seguridad (token) para confirmar la acción.
router.patch('/:id/confirm-delivery', async (req, res) => {
    ...
    try {
        ...
        console.error('Error al confirmar la entrega del caso en el router:', error);
...
// Requiere una clave de seguridad (token) para confirmar la eliminación.
router.delete('/:id/delete-with-password', async (req, res) => {
    ...
    try {
        ...
        console.error('Error al eliminar el caso en el router:', error);
